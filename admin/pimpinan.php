...
<head>
  ...
  <style>
    *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
    ...
    .badge-current { display:inline-block; padding:3px 10px; background:rgba(201,168,76,0.15); border:1px solid rgba(201,168,76,0.4); border-radius:100px; font-size:0.65rem; font-family:'Oswald',sans-serif; text-transform:uppercase; letter-spacing:1px; color:var(--gold); }
    .badge-prev { display:inline-block; padding:3px 10px; background:rgba(255,255,255,0.05); border:1px solid rgba(255,255,255,0.1); border-radius:100px; font-size:0.65rem; color:var(--gray-400); }
      ...
      <form method="POST" enctype="multipart/form-data" id="formPimpinan">
        ...
        <div class="form-group">
          <label class="checkbox-label">
            ...
            Tandai sebagai Pimpinan Aktif (akan menggantikan yang sebelumnya)
          </label>
        </div>
      ...
      <table class="data-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <?php if ($p['is_current']): ?>
              <span class="badge-current">✦ Aktif</span>
              <?php else: ?>
