  ...
  <div class="workshop-page" id="page-pimpinan">
    ...
    <section class="workshop-hero">
      <div class="workshop-hero-bg">
        <img src="assets/images/hero-bg.png" alt="Pimpinan BENGPUSKOMLEKAD">
      </div>
      <div class="workshop-hero-content">
        <div class="workshop-badge"><span>BENGPUSKOMLEKAD</span></div>
        <h1>Pimpinan <span class="gold-text">Bengpuskomlekad</span></h1>
        <p>Daftar pimpinan Bengkel Pusat Komunikasi dan Elektronika Angkatan Darat</p>
      </div>
    </section>
          ...
          <div class="pimpinan-card-featured">
            <div class="pimpinan-photo-wrap featured">
              <div class="pimpinan-photo-placeholder featured">
                  <span ><img src="assets/images/kabeng.jpeg" alt="Kolonel Cke Setyo Budi Nugroho, S.Sos." class="pimpinan-kabeng"></span>
              </div>
              <div class="pimpinan-badge-current">Pimpinan Aktif</div>
            </div>
            <div class="pimpinan-info-featured">
              <div class="pimpinan-jabatan-label">Kepala BENGPUSKOMLEKAD</div>
              <h2 class="pimpinan-nama">Kolonel Cke Setyo Budi Nugroho, S.Sos.</h2>
              <div class="pimpinan-nrp-row">
                <span class="nrp-value">NRP</span>
                <span class="nrp-value">11000059490779</span>
              </div>
              <div class="pimpinan-period">
                <!--<span class="period-icon">📅</span>-->
                <span>Masa Jabatan: 2025 – Sekarang</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="pimpinan-timeline-item fade-in">
            ...
            <div class="pimpinan-card-small">
              <div class="pimpinan-photo-small">
                <img src="assets/images/kabeng-hatta.jpg" alt="Kolonel Cke Muh. Hatta, M.P.M., MCap.Mgt." class="pimpinan-kabeng-lama">
              </div>
              <div class="pimpinan-info-small">
                <div class="pimpinan-jabatan-label-small">Kepala Bengpuskomlekad</div>
                <div class="pimpinan-nama-small">Kolonel Cke Muh. Hatta, M.P.M., MCap.Mgt.</div>
