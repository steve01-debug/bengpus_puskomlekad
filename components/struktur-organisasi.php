  ...
  <div class="workshop-page" id="page-orgas">
    ...
    <section class="orgas-section">
      <div class="container-wide">
        ...
        <!-- Unsur Pimpinan -->
        <div class="orgas-layer-label fade-in">Unsur Pimpinan</div>
        ...
        <div class="orgas-v-connector"></div>

        <!-- Unsur Pembantu Pimpinan -->
        <div class="orgas-layer-label fade-in">Unsur Pembantu Pimpinan</div>
        <div class="orgas-layer fade-in">
        ...
        <!-- Unsur Pelayanan -->
        <div class="orgas-layer-label fade-in">Unsur Pelayanan</div>
        <div class="orgas-layer fade-in">
          <div class="orgas-card">
        ...
        <!-- Unsur Pelaksana -->
        <div class="orgas-layer-label fade-in">Unsur Pelaksana</div>
        <div class="orgas-layer orgas-pelaksana fade-in">
