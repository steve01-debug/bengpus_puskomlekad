  <!-- Bengkel Sistem Elektronika -->
  <div class="workshop-page" id="workshop-elektronika">
    <button class="back-btn" onclick="showMainPage()">← Kembali</button>
    <section class="workshop-hero">
      <div class="workshop-hero-bg">
        <img src="assets/images/bengkel-elektronika.png" alt="Bengkel Elektronika">
      </div>
      <div class="workshop-hero-content">
        <div class="workshop-badge"><span>Kabeng Sislek</span></div>
        <h1>Bengkel <span class="gold-text">Sistem Elektronika</span></h1>
        <p>Pusat pemeliharaan sistem elektronika dan peralatan militer berteknologi tinggi.</p>
      </div>
    </section>
