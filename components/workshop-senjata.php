  <!-- Bengkel Persenjataan -->
  <div class="workshop-page" id="workshop-senjata">
    <button class="back-btn" onclick="showMainPage()">← Kembali</button>
    <section class="workshop-hero">
      <div class="workshop-hero-bg">
        <img src="assets/images/bengkel-senjata.png" alt="Bengkel Jaringan Internet & TIK">
      </div>
      <div class="workshop-hero-content">
        <div class="workshop-badge"><span>Kabeng Jarnet TIK</span></div>
        <h1>Bengkel <span class="gold-text">Jaringan Internet & TIK</span></h1>
        <p>Pemeliharaan dan perbaikan jaringan internet & TIK dengan presisi dan akurasi tertinggi.</p>
      </div>
    </section>
